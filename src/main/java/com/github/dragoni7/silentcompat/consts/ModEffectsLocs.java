...
public class ModEffectsLocs {
	...
	public static final ResourceLocation SPELLDAMAGE = new ResourceLocation("ars_nouveau", "spell_damage");
	
	public static final ResourceLocation GRAVITY = new ResourceLocation("ars_nouveau", "gravity");
