...
public class PacketVolatileParticles extends AbstractPacketDisplayHitParticle {

	public PacketVolatileParticles(int hitEntity) {
		super(hitEntity);
	}

	public PacketVolatileParticles(FriendlyByteBuf buf) {
		super(buf);
	}
